...
{\color{incolor}In [{\color{incolor}2}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Replace each question mark with the appropriate value. }
        ...
        \PY{k+kn}{import} \PY{n+nn}{skimage}\PY{n+nn}{.}\PY{n+nn}{data}
        ...
        \PY{n}{n\PYZus{}classes} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{unique}\PY{p}{(}\PY{n}{y\PYZus{}train}\PY{p}{)}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
...
{\color{incolor}In [{\color{incolor}3}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Data exploration visualization code goes here.}
        ...
        \PY{k+kn}{from} \PY{n+nn}{skimage}\PY{n+nn}{.}\PY{n+nn}{transform} \PY{k}{import} \PY{n}{SimilarityTransform}
        \PY{k+kn}{from} \PY{n+nn}{skimage}\PY{n+nn}{.}\PY{n+nn}{transform} \PY{k}{import} \PY{n}{warp}
        
        \PY{k}{def} \PY{n+nf}{distort}\PY{p}{(}\PY{n}{img}\PY{p}{)}\PY{p}{:}
            \PY{n}{shift\PYZus{}y}\PY{p}{,} \PY{n}{shift\PYZus{}x} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{img}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{p}{:}\PY{l+m+mi}{2}\PY{p}{]}\PY{p}{)} \PY{o}{/} \PY{l+m+mf}{2.}
            
            \PY{n}{shift} \PY{o}{=} \PY{n}{SimilarityTransform}\PY{p}{(}\PY{n}{translation}\PY{o}{=}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{n}{shift\PYZus{}x}\PY{p}{,} \PY{o}{\PYZhy{}}\PY{n}{shift\PYZus{}y}\PY{p}{]}\PY{p}{)}
            \PY{n}{tf} \PY{o}{=} \PY{n}{SimilarityTransform}\PY{p}{(}
                \PY{n}{rotation}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{deg2rad}\PY{p}{(}\PY{n}{random}\PY{o}{.}\PY{n}{uniform}\PY{p}{(}\PY{o}{\PYZhy{}}\PY{l+m+mf}{5.0}\PY{p}{,} \PY{l+m+mf}{5.0}\PY{p}{)}\PY{p}{)}\PY{p}{,} 
                \PY{n}{scale}\PY{o}{=}\PY{n}{random}\PY{o}{.}\PY{n}{uniform}\PY{p}{(}\PY{l+m+mf}{0.9}\PY{p}{,} \PY{l+m+mf}{1.1}\PY{p}{)}\PY{p}{,}
                \PY{n}{translation}\PY{o}{=}\PY{p}{(}\PY{n}{random}\PY{o}{.}\PY{n}{uniform}\PY{p}{(}\PY{o}{\PYZhy{}}\PY{l+m+mf}{0.1}\PY{p}{,} \PY{l+m+mf}{0.1}\PY{p}{)}\PY{o}{*}\PY{n}{img}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,} \PY{n}{random}\PY{o}{.}\PY{n}{uniform}\PY{p}{(}\PY{o}{\PYZhy{}}\PY{l+m+mf}{0.1}\PY{p}{,} \PY{l+m+mf}{0.1}\PY{p}{)}\PY{o}{*}\PY{n}{img}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}
            \PY{p}{)}
            \PY{n}{shift\PYZus{}inv} \PY{o}{=} \PY{n}{SimilarityTransform}\PY{p}{(}\PY{n}{translation}\PY{o}{=}\PY{p}{[}\PY{n}{shift\PYZus{}x}\PY{p}{,} \PY{n}{shift\PYZus{}y}\PY{p}{]}\PY{p}{)}
            
            \PY{k}{return} \PY{n}{warp}\PY{p}{(}\PY{n}{img}\PY{p}{,} \PY{p}{(}\PY{n}{shift} \PY{o}{+} \PY{p}{(}\PY{n}{tf} \PY{o}{+} \PY{n}{shift\PYZus{}inv}\PY{p}{)}\PY{p}{)}\PY{o}{.}\PY{n}{inverse}\PY{p}{,} \PY{n}{mode}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{edge}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        
        \PY{k+kn}{import} \PY{n+nn}{skimage}\PY{n+nn}{.}\PY{n+nn}{exposure}
        \PY{k}{def} \PY{n+nf}{exposureAdjust}\PY{p}{(}\PY{n}{img}\PY{p}{)}\PY{p}{:}
            \PY{n}{img\PYZus{}}\PY{o}{=}\PY{n}{skimage}\PY{o}{.}\PY{n}{exposure}\PY{o}{.}\PY{n}{equalize\PYZus{}hist}\PY{p}{(}\PY{n}{img}\PY{p}{)}
            \PY{k}{return} \PY{n}{skimage}\PY{o}{.}\PY{n}{img\PYZus{}as\PYZus{}ubyte}\PY{p}{(}\PY{n}{skimage}\PY{o}{.}\PY{n}{exposure}\PY{o}{.}\PY{n}{adjust\PYZus{}gamma}\PY{p}{(}\PY{n}{img\PYZus{}}\PY{p}{,} \PY{n}{random}\PY{o}{.}\PY{n}{uniform}\PY{p}{(}\PY{l+m+mf}{0.1}\PY{p}{,}\PY{l+m+mf}{1.01}\PY{p}{)}\PY{p}{)}\PY{p}{)}
        
        \PY{k}{def} \PY{n+nf}{Preprocess\PYZus{}all}\PY{p}{(}\PY{n}{images}\PY{p}{)}\PY{p}{:}
            \PY{n}{res} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{empty\PYZus{}like}\PY{p}{(}\PY{n}{images}\PY{p}{)}
            \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{images}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{:}
                \PY{n}{res}\PY{p}{[}\PY{n}{i}\PY{p}{]} \PY{o}{=} \PY{n}{exposureAdjust}\PY{p}{(}\PY{n}{distort}\PY{p}{(}\PY{n}{images}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{)}\PY{p}{)}
            \PY{k}{return} \PY{n}{res}
        
        \PY{c+c1}{\PYZsh{} Sample images to show}
        \PY{k}{def} \PY{n+nf}{showDistortEffect}\PY{p}{(}\PY{n}{x}\PY{p}{)}\PY{p}{:}
            \PY{n}{img\PYZus{}ind}\PY{o}{=}\PY{n}{random}\PY{o}{.}\PY{n}{randint}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{n}{n\PYZus{}train}\PY{p}{)}
            \PY{n}{plt}\PY{o}{.}\PY{n}{subplot}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{)}
            \PY{n}{plt}\PY{o}{.}\PY{n}{axis}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{off}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
            \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{x}\PY{p}{[}\PY{n}{img\PYZus{}ind}\PY{p}{]}\PY{p}{)}
            \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{original\PYZus{}Img}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
            \PY{n}{plt}\PY{o}{.}\PY{n}{subplot}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{)}
            \PY{n}{plt}\PY{o}{.}\PY{n}{axis}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{off}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
            \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{exposureAdjust}\PY{p}{(}\PY{n}{distort}\PY{p}{(}\PY{n}{x}\PY{p}{[}\PY{n}{img\PYZus{}ind}\PY{p}{]}\PY{p}{)}\PY{p}{)}\PY{p}{)}
            \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{distorted\PYZus{}Img}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
            \PY{n}{plt}\PY{o}{.}\PY{n}{suptitle}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Distorted Comparison}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
            \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
            \PY{k}{return}
        
        \PY{n}{showDistortEffect}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{)}
\end{Verbatim}
...
D:\textbackslash{}anaconda\textbackslash{}soft\textbackslash{}envs\textbackslash{}carnd-term1\textbackslash{}lib\textbackslash{}site-packages\textbackslash{}skimage\textbackslash{}util\textbackslash{}dtype.py:130: UserWarning: Possible precision loss when converting from float64 to uint8
  .format(dtypeobj\_in, dtypeobj\_out))
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
Type is  uint8  and  uint8

    \end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}4}]:} \PY{c+c1}{\PYZsh{} create Artificial data}
        \PY{n}{X\PYZus{}train} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{concatenate}\PY{p}{(}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{Preprocess\PYZus{}all}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{)}\PY{p}{)}\PY{p}{)}
        \PY{n}{y\PYZus{}train} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{concatenate}\PY{p}{(}\PY{p}{(}\PY{n}{y\PYZus{}train}\PY{p}{,} \PY{n}{y\PYZus{}train}\PY{p}{)}\PY{p}{)}
        \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{After adding fake data, X\PYZus{}train}\PY{l+s+s2}{\PYZsq{}}\PY{l+s+s2}{s shape is }\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{X\PYZus{}train}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}
\end{Verbatim}
...
After adding fake data, X\_train's shape is  69598
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}5}]:} \PY{c+c1}{\PYZsh{} draw histogram}
        \PY{k}{def} \PY{n+nf}{drawHist}\PY{p}{(}\PY{n}{y}\PY{p}{)}\PY{p}{:}
            \PY{n}{class\PYZus{}index}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{n}{n\PYZus{}classes}\PY{p}{)}
            \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{y}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{:}
                \PY{n}{class\PYZus{}index}\PY{p}{[}\PY{n}{y}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{]}\PY{o}{+}\PY{o}{=}\PY{l+m+mi}{1}
            \PY{n}{plt}\PY{o}{.}\PY{n}{bar}\PY{p}{(}\PY{n+nb}{range}\PY{p}{(}\PY{n}{n\PYZus{}classes}\PY{p}{)}\PY{p}{,} \PY{n+nb}{list}\PY{p}{(}\PY{n+nb}{map}\PY{p}{(}\PY{k}{lambda} \PY{n}{i}\PY{p}{:} \PY{n}{class\PYZus{}index}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{,} \PY{n+nb}{range}\PY{p}{(}\PY{n}{n\PYZus{}classes}\PY{p}{)}\PY{p}{)}\PY{p}{)}\PY{p}{)}
            \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Traffic Sign Class}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
            \PY{n}{plt}\PY{o}{.}\PY{n}{ylabel}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Count of each sign}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
            \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
        \PY{n}{drawHist}\PY{p}{(}\PY{n}{y\PYZus{}train}\PY{p}{)}
        
        \PY{c+c1}{\PYZsh{} plotting traffic sign images}
        \PY{k}{def} \PY{n+nf}{display\PYZus{}images\PYZus{}and\PYZus{}labels}\PY{p}{(}\PY{n}{\PYZus{}x}\PY{p}{,}\PY{n}{y}\PY{p}{)}\PY{p}{:}
            \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{15}\PY{p}{,} \PY{l+m+mi}{15}\PY{p}{)}\PY{p}{)}
            \PY{n}{i}\PY{o}{=}\PY{l+m+mi}{1}
            \PY{k}{if} \PY{n+nb}{type}\PY{p}{(}\PY{n}{y}\PY{p}{)} \PY{o}{!=} \PY{n+nb}{list}\PY{p}{:}
                \PY{n}{\PYZus{}y}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{unique}\PY{p}{(}\PY{n}{y}\PY{p}{)}\PY{o}{.}\PY{n}{tolist}\PY{p}{(}\PY{p}{)}
                \PY{n}{y\PYZus{}list}\PY{o}{=}\PY{n}{y}\PY{o}{.}\PY{n}{tolist}\PY{p}{(}\PY{p}{)}
            \PY{k}{else}\PY{p}{:}
                \PY{n}{\PYZus{}y}\PY{o}{=}\PY{n}{y}
                \PY{n}{y\PYZus{}list}\PY{o}{=}\PY{n}{y}
            
            \PY{k}{for} \PY{n}{cla} \PY{o+ow}{in} \PY{n}{\PYZus{}y}\PY{p}{:}
                \PY{n}{image}\PY{o}{=} \PY{n}{\PYZus{}x}\PY{p}{[}\PY{n}{y\PYZus{}list}\PY{o}{.}\PY{n}{index}\PY{p}{(}\PY{n}{cla}\PY{p}{)}\PY{p}{]}
                \PY{n}{plt}\PY{o}{.}\PY{n}{subplot}\PY{p}{(}\PY{l+m+mi}{7}\PY{p}{,} \PY{l+m+mi}{7}\PY{p}{,} \PY{n}{i}\PY{p}{)}
                \PY{n}{plt}\PY{o}{.}\PY{n}{axis}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{off}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
                \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Label:}\PY{l+s+si}{\PYZob{}0\PYZcb{}}\PY{l+s+s2}{\PYZhy{}}\PY{l+s+si}{\PYZob{}1\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{cla}\PY{p}{,} \PY{n}{y\PYZus{}list}\PY{o}{.}\PY{n}{count}\PY{p}{(}\PY{n}{cla}\PY{p}{)}\PY{p}{)}\PY{p}{)}
                \PY{n}{i} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}
                \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{image}\PY{p}{)}
            \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
        \PY{n}{display\PYZus{}images\PYZus{}and\PYZus{}labels}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{y\PYZus{}train}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}6}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Preprocess the data here. It is required to normalize the data. Other preprocessing steps could include }
        ...
        \PY{c+c1}{\PYZsh{} TODO here preprocessing}
        
        \PY{k}{def} \PY{n+nf}{convert\PYZus{}grayscale}\PY{p}{(}\PY{n}{x}\PY{p}{)}\PY{p}{:}
            \PY{n}{conv\PYZus{}gray}\PY{o}{=}\PY{n}{tf}\PY{o}{.}\PY{n}{constant}\PY{p}{(}\PY{l+m+mf}{1.0}\PY{o}{/}\PY{l+m+mf}{3.0}\PY{p}{,}\PY{n}{dtype}\PY{o}{=}\PY{n}{tf}\PY{o}{.}\PY{n}{float32}\PY{p}{,}\PY{n}{shape}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)}
            \PY{k}{return} \PY{n}{tf}\PY{o}{.}\PY{n}{nn}\PY{o}{.}\PY{n}{conv2d}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{n}{conv\PYZus{}gray}\PY{p}{,}\PY{n}{strides}\PY{o}{=}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,}\PY{n}{padding}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{VALID}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        
        \PY{k}{def} \PY{n+nf}{normalize}\PY{p}{(}\PY{n}{x}\PY{p}{)}\PY{p}{:}
            \PY{n}{var\PYZus{}nor}\PY{o}{=}\PY{n}{tf}\PY{o}{.}\PY{n}{constant}\PY{p}{(}\PY{l+m+mf}{128.0}\PY{p}{,}\PY{n}{dtype}\PY{o}{=}\PY{n}{tf}\PY{o}{.}\PY{n}{float32}\PY{p}{)}
            \PY{k}{return} \PY{n}{tf}\PY{o}{.}\PY{n}{div}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{sub}\PY{p}{(}\PY{n}{x}\PY{p}{,}\PY{n}{var\PYZus{}nor}\PY{p}{)}\PY{p}{,} \PY{n}{var\PYZus{}nor}\PY{p}{)}
        \PY{c+c1}{\PYZsh{} probability to keep units}
...
{\color{incolor}In [{\color{incolor}7}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Define your architecture here.}
        ...
        \PY{k}{def} \PY{n+nf}{LeNet}\PY{p}{(}\PY{n}{x}\PY{p}{)}\PY{p}{:}    
            ...
            \PY{n}{conv1} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{nn}\PY{o}{.}\PY{n}{relu}\PY{p}{(}\PY{n}{conv1}\PY{p}{,}\PY{n}{name}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{conv1}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
            \PY{n+nb}{print}\PY{p}{(}\PY{n}{conv1}\PY{p}{)}
            ...
            \PY{c+c1}{\PYZsh{} SOLUTION: Activation.}
            \PY{n}{conv2} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{nn}\PY{o}{.}\PY{n}{relu}\PY{p}{(}\PY{n}{conv2}\PY{p}{,}\PY{n}{name}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{conv2}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
            \PY{n+nb}{print}\PY{p}{(}\PY{n}{conv2}\PY{p}{)}
            ...
            \PY{n}{tf}\PY{o}{.}\PY{n}{add\PYZus{}to\PYZus{}collection}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{losses}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{tf}\PY{o}{.}\PY{n}{contrib}\PY{o}{.}\PY{n}{layers}\PY{o}{.}\PY{n}{l2\PYZus{}regularizer}\PY{p}{(}\PY{n}{lambda1}\PY{p}{)}\PY{p}{(}\PY{n}{fc1\PYZus{}W}\PY{p}{)}\PY{p}{)}
            ...
            \PY{n}{tf}\PY{o}{.}\PY{n}{add\PYZus{}to\PYZus{}collection}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{losses}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{tf}\PY{o}{.}\PY{n}{contrib}\PY{o}{.}\PY{n}{layers}\PY{o}{.}\PY{n}{l2\PYZus{}regularizer}\PY{p}{(}\PY{n}{lambda1}\PY{p}{)}\PY{p}{(}\PY{n}{fc2\PYZus{}W}\PY{p}{)}\PY{p}{)}
            ...
            \PY{n}{tf}\PY{o}{.}\PY{n}{add\PYZus{}to\PYZus{}collection}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{losses}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{tf}\PY{o}{.}\PY{n}{contrib}\PY{o}{.}\PY{n}{layers}\PY{o}{.}\PY{n}{l2\PYZus{}regularizer}\PY{p}{(}\PY{n}{lambda1}\PY{p}{)}\PY{p}{(}\PY{n}{fc3\PYZus{}W}\PY{p}{)}\PY{p}{)}
        ...
        \PY{c+c1}{\PYZsh{} use tensorflow to normalize}
        \PY{n}{x\PYZus{}gray}\PY{o}{=} \PY{n}{convert\PYZus{}grayscale}\PY{p}{(}\PY{n}{x}\PY{p}{)}
        \PY{n}{x\PYZus{}pre}\PY{o}{=} \PY{n}{normalize}\PY{p}{(}\PY{n}{x\PYZus{}gray}\PY{p}{)}
        \PY{n}{logits} \PY{o}{=} \PY{n}{LeNet}\PY{p}{(}\PY{n}{x\PYZus{}pre}\PY{p}{)}
        
        \PY{n}{predicted\PYZus{}labels} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{argmax}\PY{p}{(}\PY{n}{logits}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{)}
        ...
        \PY{n}{loss\PYZus{}operation} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{cast}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{reduce\PYZus{}mean}\PY{p}{(}\PY{n}{cross\PYZus{}entropy}\PY{p}{)}\PY{p}{,}\PY{n}{tf}\PY{o}{.}\PY{n}{float32}\PY{p}{)}
        \PY{c+c1}{\PYZsh{}tf.add\PYZus{}to\PYZus{}collection(\PYZdq{}losses\PYZdq{},loss\PYZus{}operation)}
        \PY{c+c1}{\PYZsh{}loss = tf.add\PYZus{}n(tf.get\PYZus{}collection(\PYZdq{}losses\PYZdq{}))}
...
{\color{incolor}In [{\color{incolor}8}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Train your model here.}
        ...
        \PY{k}{with} \PY{n}{tf}\PY{o}{.}\PY{n}{Session}\PY{p}{(}\PY{p}{)} \PY{k}{as} \PY{n}{sess}\PY{p}{:}
            ...
            \PY{c+c1}{\PYZsh{} TODO need add load model}
            \PY{n}{saver}\PY{o}{.}\PY{n}{save}\PY{p}{(}\PY{n}{sess}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./lenet3}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor}10}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Load the images and plot them here.}
         ...
         \PY{k}{def} \PY{n+nf}{load\PYZus{}data}\PY{p}{(}\PY{n}{data\PYZus{}dir}\PY{p}{)}\PY{p}{:}
             \PY{n}{images}\PY{o}{=}\PY{p}{[}\PY{p}{]}
             \PY{n}{labels}\PY{o}{=}\PY{p}{[}\PY{p}{]}
             \PY{n}{i}\PY{o}{=}\PY{l+m+mi}{0}
             \PY{k}{for} \PY{n}{f} \PY{o+ow}{in} \PY{n}{os}\PY{o}{.}\PY{n}{listdir}\PY{p}{(}\PY{n}{data\PYZus{}dir}\PY{p}{)}\PY{p}{:}
                 \PY{n}{shotname}\PY{p}{,}\PY{n}{extension} \PY{o}{=} \PY{n}{os}\PY{o}{.}\PY{n}{path}\PY{o}{.}\PY{n}{splitext}\PY{p}{(}\PY{n}{f}\PY{p}{)}
                 \PY{n}{labels}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n+nb}{int}\PY{p}{(}\PY{n}{shotname}\PY{p}{)}\PY{p}{)}
                 \PY{n}{image\PYZus{}dir}\PY{o}{=}\PY{n}{os}\PY{o}{.}\PY{n}{path}\PY{o}{.}\PY{n}{join}\PY{p}{(}\PY{n}{data\PYZus{}dir}\PY{p}{,} \PY{n}{f}\PY{p}{)}
                 \PY{n}{temp\PYZus{}img}\PY{o}{=}\PY{n}{skimage}\PY{o}{.}\PY{n}{transform}\PY{o}{.}\PY{n}{resize}\PY{p}{(}\PY{n}{skimage}\PY{o}{.}\PY{n}{data}\PY{o}{.}\PY{n}{imread}\PY{p}{(}\PY{n}{image\PYZus{}dir}\PY{p}{)}\PY{p}{,} \PY{p}{(}\PY{l+m+mi}{32}\PY{p}{,} \PY{l+m+mi}{32}\PY{p}{)}\PY{p}{,} \PY{n}{mode}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{constant}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
                 \PY{n}{images}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{skimage}\PY{o}{.}\PY{n}{img\PYZus{}as\PYZus{}ubyte}\PY{p}{(}\PY{n}{temp\PYZus{}img}\PY{p}{)}\PY{p}{)}
                 \PY{n}{i}\PY{o}{+}\PY{o}{=}\PY{l+m+mi}{1}
             \PY{k}{return} \PY{n}{images}\PY{p}{,} \PY{n}{labels}
         
         \PY{n}{ROOT\PYZus{}PATH} \PY{o}{=} \PY{n}{os}\PY{o}{.}\PY{n}{path}\PY{o}{.}\PY{n}{abspath}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{.}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{imgFilePath}\PY{o}{=}\PY{n}{os}\PY{o}{.}\PY{n}{path}\PY{o}{.}\PY{n}{join}\PY{p}{(}\PY{n}{ROOT\PYZus{}PATH}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{testImg}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         
         \PY{n}{images1}\PY{p}{,} \PY{n}{labels1} \PY{o}{=} \PY{n}{load\PYZus{}data}\PY{p}{(}\PY{n}{imgFilePath}\PY{p}{)}
         \PY{n}{display\PYZus{}images\PYZus{}and\PYZus{}labels}\PY{p}{(}\PY{n}{images1}\PY{p}{,}\PY{n}{labels1}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}11}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Run the predictions here and use the model to output the prediction for each image.}
         ...
         \PY{k}{with} \PY{n}{tf}\PY{o}{.}\PY{n}{Session}\PY{p}{(}\PY{p}{)} \PY{k}{as} \PY{n}{sess}\PY{p}{:}
             \PY{n}{saver}\PY{o}{.}\PY{n}{restore}\PY{p}{(}\PY{n}{sess}\PY{p}{,} \PY{n}{tf}\PY{o}{.}\PY{n}{train}\PY{o}{.}\PY{n}{latest\PYZus{}checkpoint}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{.}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{)}
             \PY{n}{predictions}\PY{o}{=}\PY{n}{sess}\PY{o}{.}\PY{n}{run}\PY{p}{(}\PY{n}{predicted\PYZus{}labels}\PY{p}{,} \PY{n}{feed\PYZus{}dict}\PY{o}{=}\PY{p}{\PYZob{}}\PY{n}{x}\PY{p}{:} \PY{n}{images1}\PY{p}{,} \PY{n}{keep\PYZus{}prob}\PY{p}{:} \PY{l+m+mf}{1.0}\PY{p}{\PYZcb{}}\PY{p}{)}
         \PY{n+nb}{print} \PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Predictions : }\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{n}{predictions}\PY{p}{)}
         \PY{n+nb}{print} \PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Labels      : }\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{n}{labels1}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
Predictions :  [24 30 34 39 41  8]
Labels      :  [24, 30, 34, 39, 41, 8]
...
{\color{incolor}In [{\color{incolor}12}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Calculate the accuracy for these 5 new images. }
         ...
         \PY{k}{def} \PY{n+nf}{calcu\PYZus{}accuracy}\PY{p}{(}\PY{n}{labels}\PY{p}{,} \PY{n}{answers}\PY{p}{)}\PY{p}{:}
             \PY{n}{right\PYZus{}cnt}\PY{o}{=}\PY{l+m+mf}{0.}
             \PY{k}{for} \PY{n}{lab}\PY{p}{,} \PY{n}{ans} \PY{o+ow}{in} \PY{n+nb}{zip}\PY{p}{(}\PY{n}{labels} \PY{p}{,} \PY{n}{answers}\PY{p}{)}\PY{p}{:}
                 \PY{k}{if} \PY{n}{lab}\PY{o}{==}\PY{n}{ans}\PY{p}{:}
                     \PY{n}{right\PYZus{}cnt} \PY{o}{+}\PY{o}{=}\PY{l+m+mf}{1.}
             \PY{k}{return} \PY{n}{right\PYZus{}cnt}\PY{o}{/}\PY{n+nb}{len}\PY{p}{(}\PY{n}{labels}\PY{p}{)}
         
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Accuracy is }\PY{l+s+si}{\PYZob{}:.2\PYZpc{}\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{calcu\PYZus{}accuracy}\PY{p}{(}\PY{n}{labels1}\PY{p}{,} \PY{n}{predictions}\PY{p}{)}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}13}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Print out the top five softmax probabilities for the predictions on the German traffic sign images found on the web. }
         \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Feel free to use as many code cells as needed.}
         \PY{n}{top\PYZus{}5}\PY{o}{=}\PY{n}{tf}\PY{o}{.}\PY{n}{nn}\PY{o}{.}\PY{n}{top\PYZus{}k}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{nn}\PY{o}{.}\PY{n}{softmax}\PY{p}{(}\PY{n}{logits}\PY{p}{)}\PY{p}{,}\PY{l+m+mi}{5}\PY{p}{)}
         \PY{k}{with} \PY{n}{tf}\PY{o}{.}\PY{n}{Session}\PY{p}{(}\PY{p}{)} \PY{k}{as} \PY{n}{sess}\PY{p}{:}
             \PY{n}{saver}\PY{o}{.}\PY{n}{restore}\PY{p}{(}\PY{n}{sess}\PY{p}{,} \PY{n}{tf}\PY{o}{.}\PY{n}{train}\PY{o}{.}\PY{n}{latest\PYZus{}checkpoint}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{.}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{)}
             \PY{n}{ans\PYZus{}top\PYZus{}5}\PY{o}{=}\PY{n}{sess}\PY{o}{.}\PY{n}{run}\PY{p}{(}\PY{n}{top\PYZus{}5}\PY{p}{,} \PY{n}{feed\PYZus{}dict}\PY{o}{=}\PY{p}{\PYZob{}}\PY{n}{x}\PY{p}{:} \PY{n}{images1}\PY{p}{,} \PY{n}{keep\PYZus{}prob}\PY{p}{:} \PY{l+m+mf}{1.0}\PY{p}{\PYZcb{}}\PY{p}{)}
         \PY{n}{ind\PYZus{}top5}\PY{o}{=}\PY{n}{ans\PYZus{}top\PYZus{}5}\PY{o}{.}\PY{n}{indices}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{The top5 index is:}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{n}{ind\PYZus{}top5}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{} plotting traffic sign images}
         \PY{k}{def} \PY{n+nf}{display\PYZus{}labels\PYZus{}and\PYZus{}ans}\PY{p}{(}\PY{n}{imgs}\PY{p}{,}\PY{n}{labs}\PY{p}{,}\PY{n}{inds}\PY{p}{)}\PY{p}{:}
             \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{10}\PY{p}{,} \PY{l+m+mi}{10}\PY{p}{)}\PY{p}{)}
             \PY{n}{show\PYZus{}rows}\PY{o}{=}\PY{n+nb}{len}\PY{p}{(}\PY{n}{labs}\PY{p}{)}
             \PY{n}{show\PYZus{}cols}\PY{o}{=}\PY{n+nb}{len}\PY{p}{(}\PY{n}{inds}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}
             \PY{n}{y\PYZus{}list}\PY{o}{=}\PY{n}{y\PYZus{}test}\PY{o}{.}\PY{n}{tolist}\PY{p}{(}\PY{p}{)}
             \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{show\PYZus{}rows}\PY{p}{)}\PY{p}{:}
                 \PY{n}{plt}\PY{o}{.}\PY{n}{subplot}\PY{p}{(}\PY{n}{show\PYZus{}rows}\PY{p}{,}\PY{n}{show\PYZus{}cols}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{,}\PY{n}{i}\PY{o}{*}\PY{n}{show\PYZus{}cols}\PY{o}{+}\PY{n}{i}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)}
                 \PY{n}{plt}\PY{o}{.}\PY{n}{axis}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{off}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
                 \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Label:}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{labs}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{)}\PY{p}{)}
                 \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{imgs}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{)}
                 \PY{k}{for} \PY{n}{j} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{show\PYZus{}cols}\PY{p}{)}\PY{p}{:}
                     \PY{n}{image}\PY{o}{=}\PY{n}{X\PYZus{}test}\PY{p}{[}\PY{n}{y\PYZus{}list}\PY{o}{.}\PY{n}{index}\PY{p}{(}\PY{n}{inds}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{[}\PY{n}{j}\PY{p}{]}\PY{p}{)}\PY{p}{]}
                     \PY{n}{plt}\PY{o}{.}\PY{n}{subplot}\PY{p}{(}\PY{n}{show\PYZus{}rows}\PY{p}{,}\PY{n}{show\PYZus{}cols}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{,}\PY{n}{i}\PY{o}{*}\PY{n}{show\PYZus{}cols}\PY{o}{+}\PY{n}{i}\PY{o}{+}\PY{l+m+mi}{2}\PY{o}{+}\PY{n}{j}\PY{p}{)}
                     \PY{n}{plt}\PY{o}{.}\PY{n}{axis}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{off}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
                     \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{top5\PYZus{}ans:}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{inds}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{[}\PY{n}{j}\PY{p}{]}\PY{p}{)}\PY{p}{)}
                     \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{image}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
             \PY{k}{return}
         
         \PY{n}{display\PYZus{}labels\PYZus{}and\PYZus{}ans}\PY{p}{(}\PY{n}{images1}\PY{p}{,} \PY{n}{labels1}\PY{p}{,}\PY{n}{ind\PYZus{}top5}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}14}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Visualize your network\PYZsq{}s feature maps here.}
         ...
         \PY{k}{def} \PY{n+nf}{outputFeatureMap}\PY{p}{(}\PY{n}{image\PYZus{}input}\PY{p}{,} \PY{n}{tf\PYZus{}activation}\PY{p}{,} \PY{n}{activation\PYZus{}min}\PY{o}{=}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{activation\PYZus{}max}\PY{o}{=}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1} \PY{p}{,}\PY{n}{plt\PYZus{}num}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{:}
             ...
             \PY{n}{plt}\PY{o}{.}\PY{n}{suptitle}\PY{p}{(}\PY{n}{tf\PYZus{}activation}\PY{o}{.}\PY{n}{name}\PY{p}{)}
             \PY{k}{for} \PY{n}{featuremap} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{featuremaps}\PY{p}{)}\PY{p}{:}
                 ...
                 \PY{k}{if} \PY{n}{activation\PYZus{}min} \PY{o}{!=} \PY{o}{\PYZhy{}}\PY{l+m+mi}{1} \PY{o}{\PYZam{}} \PY{n}{activation\PYZus{}max} \PY{o}{!=} \PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{:}
                     \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{activation}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,}\PY{p}{:}\PY{p}{,}\PY{p}{:}\PY{p}{,} \PY{n}{featuremap}\PY{p}{]}\PY{p}{,} \PY{n}{interpolation}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{nearest}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} 
                                \PY{n}{vmin} \PY{o}{=}\PY{n}{activation\PYZus{}min}\PY{p}{,} \PY{n}{vmax}\PY{o}{=}\PY{n}{activation\PYZus{}max}\PY{p}{,} \PY{n}{cmap}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{gray}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
                 \PY{k}{elif} \PY{n}{activation\PYZus{}max} \PY{o}{!=} \PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{:}
                     \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{activation}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,}\PY{p}{:}\PY{p}{,}\PY{p}{:}\PY{p}{,} \PY{n}{featuremap}\PY{p}{]}\PY{p}{,} \PY{n}{interpolation}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{nearest}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} 
                                \PY{n}{vmax}\PY{o}{=}\PY{n}{activation\PYZus{}max}\PY{p}{,} \PY{n}{cmap}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{gray}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
                 \PY{k}{elif} \PY{n}{activation\PYZus{}min} \PY{o}{!=}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{:}
                     \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{activation}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,}\PY{p}{:}\PY{p}{,}\PY{p}{:}\PY{p}{,} \PY{n}{featuremap}\PY{p}{]}\PY{p}{,} \PY{n}{interpolation}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{nearest}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} 
                                \PY{n}{vmin}\PY{o}{=}\PY{n}{activation\PYZus{}min}\PY{p}{,} \PY{n}{cmap}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{gray}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
                 \PY{k}{else}\PY{p}{:}
                     \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{activation}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,}\PY{p}{:}\PY{p}{,}\PY{p}{:}\PY{p}{,} \PY{n}{featuremap}\PY{p}{]}\PY{p}{,} \PY{n}{interpolation}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{nearest}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} 
                                \PY{n}{cmap}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{gray}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
             \PY{k}{return}
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}15}]:} \PY{k}{def} \PY{n+nf}{myOutputFeatureMap}\PY{p}{(}\PY{n}{imgs}\PY{p}{,}\PY{n}{labs}\PY{p}{)}\PY{p}{:}
             \PY{n}{indx}\PY{o}{=}\PY{n}{random}\PY{o}{.}\PY{n}{randint}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{n+nb}{len}\PY{p}{(}\PY{n}{labs}\PY{p}{)}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{)}
             \PY{n}{label}\PY{o}{=}\PY{n}{labs}\PY{p}{[}\PY{n}{indx}\PY{p}{]}
             \PY{n}{img\PYZus{}choose}\PY{o}{=}\PY{n}{imgs}\PY{p}{[}\PY{n}{indx}\PY{p}{]}
             \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Input img, Label:}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{label}\PY{p}{)}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{img\PYZus{}choose}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
             \PY{n}{img}\PY{o}{=}\PY{n}{img} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{expand\PYZus{}dims}\PY{p}{(}\PY{n}{img\PYZus{}choose}\PY{p}{,} \PY{n}{axis}\PY{o}{=}\PY{l+m+mi}{0}\PY{p}{)}
         
             \PY{n}{g1}\PY{o}{=}\PY{n}{tf}\PY{o}{.}\PY{n}{get\PYZus{}default\PYZus{}graph}\PY{p}{(}\PY{p}{)}
             \PY{n}{conv1}\PY{o}{=}\PY{n}{tf}\PY{o}{.}\PY{n}{Graph}\PY{o}{.}\PY{n}{get\PYZus{}tensor\PYZus{}by\PYZus{}name}\PY{p}{(}\PY{n}{g1}\PY{p}{,}\PY{n}{name}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{conv1:0}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
             \PY{n}{conv2}\PY{o}{=}\PY{n}{tf}\PY{o}{.}\PY{n}{Graph}\PY{o}{.}\PY{n}{get\PYZus{}tensor\PYZus{}by\PYZus{}name}\PY{p}{(}\PY{n}{g1}\PY{p}{,}\PY{n}{name}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{conv2:0}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
             \PY{n}{outputFeatureMap}\PY{p}{(}\PY{n}{img}\PY{p}{,} \PY{n}{conv1}\PY{p}{)}
             \PY{n}{outputFeatureMap}\PY{p}{(}\PY{n}{img}\PY{p}{,} \PY{n}{conv2}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
         
         \PY{k}{with} \PY{n}{tf}\PY{o}{.}\PY{n}{Session}\PY{p}{(}\PY{p}{)} \PY{k}{as} \PY{n}{sess}\PY{p}{:}
             \PY{n}{saver}\PY{o}{.}\PY{n}{restore}\PY{p}{(}\PY{n}{sess}\PY{p}{,} \PY{n}{tf}\PY{o}{.}\PY{n}{train}\PY{o}{.}\PY{n}{latest\PYZus{}checkpoint}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{.}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{)}
             \PY{n}{myOutputFeatureMap}\PY{p}{(}\PY{n}{images1}\PY{p}{,}\PY{n}{labels1}\PY{p}{)}
\end{Verbatim}
